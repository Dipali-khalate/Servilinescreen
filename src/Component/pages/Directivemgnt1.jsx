...
import "../Style/directivemgnt1.css";
...
import Directivemgnt1table from "../pages/Directivemgnt1table";
import CloseIcon from "@mui/icons-material/Close";
import Directivemngttable4 from "../pages/Directivemngttable4";

function Directivemgnt1() {
  const [open, setOpen] = React.useState({ first: false, sec: false ,third: false});
